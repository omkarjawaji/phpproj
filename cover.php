<!DOCTYPE html>
<html>
<body style="background-image:url(images/omicover.jpg)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul style="background-color:#80ccff">
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="imageomi/hospital-icon-vector-12-.jpg" width="30px" height="30px"><strong> Docsapp </strong>Appointment Booking made easy</a></li>
			...
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:darkgrey">
